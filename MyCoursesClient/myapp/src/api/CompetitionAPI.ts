...
export class CompetitionAPI {
    ...
    public getPosted(): Promise<IAPIResponse<any>> {
    ...
    public getCrawled(): Promise<IAPIResponse<any>> {
        return new Promise<IAPIResponse<any>>((resolve, reject) => {
    ...
    public post(data: ICompetition): Promise<IAPIResponse<any>> {
    ...
    public getPopular(): Promise<IAPIResponse<any>> {
        return new Promise<IAPIResponse<any>>((resolve, reject) => {
